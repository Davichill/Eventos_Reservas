...
<body>
    ...
    <div style="padding: 20px; max-width: 1700px; margin: auto;">
        <form method="GET" class="filters-section">
            ...
            <a href="nueva_invitacion.php" class="btn-new">+ Nueva Reserva</a>
        </form>
                ...
                <tbody>
                    <?php while ($row = $res->fetch_assoc()): ?>
                        <tr onclick='verDetalle(<?= json_encode($row); ?>)'>
                            <td>
                                <span class="status-badge <?= strtolower($row['estado']) ?>"><?= $row['estado'] ?></span>
                            </td>
                            <td>
                                <strong><?= date("d/m/Y", strtotime($row['fecha_evento'])) ?></strong><br>
                                <small>🕒 <?= $row['hora_inicio'] ? date("H:i", strtotime($row['hora_inicio'])) : '--:--' ?>
                                    a <?= $row['hora_fin'] ? date("H:i", strtotime($row['hora_fin'])) : '--:--' ?></small>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php if ($row['estado'] == 'Confirmada'): ?>
                                    ...
                                    <?php if ($row['observaciones']): ?>
                                        <div class="badge-cocina">⚠️ Cocina: <?= substr($row['observaciones'], 0, 45) ?>...</div>
                                    <?php endif; ?>
            ...
            <div class="modal-body">
                ...
                <div id="m-plan-container" class="field full"
                    ...
                    <a id="m-plan-link" href="#" target="_blank"
                        style="color: var(--info); font-weight: bold; text-decoration: none;">🖼️ VER PLANIMETRÍA</a>
                </div>
                            ...
                            <div class="form-section legal">
                                ...
                                <div class="fields-grid">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" name="direccion_fiscal" id="e-direccion" class="input-edit">
                                    </div>
                                    <div class="field">
                                ...
                                <div class="fields-grid">
                                    ...
                                    <div class="field full-width">
                                        ...
                                        <div class="time-group">
                                            <input type="time" name="hora_inicio" id="e-inicio" class="input-edit"
                                                placeholder="Inicio">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="number" name="cantidad_personas" id="e-pax" class="input-edit"
                                            min="1">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-section contact">
                                ...
                                <div class="fields-grid">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" name="contacto_evento_telefono" id="e-encargado-telefono"
                                            class="input-edit">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-section operation">
                                ...
                                <div class="fields-grid">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" name="equipos_audiovisuales" id="e-it" class="input-edit">
                                    </div>
                                    <div class="field">
                    ...
                    <div class="menu-section">
                        ...
                        <div class="menu-controls">
                            <div class="field">
                                ...
                                <select id="selector-categoria" class="input-edit" onchange="cargarSubcategorias()">
                    ...
                    <div class="notes-section">
                        ...
                        <div class="fields-grid">
                            ...
                            <div class="field">
                                ...
                                <textarea name="notas_internas" id="e-notas-internas" class="input-edit" rows="2"
                                    placeholder="Notas para el equipo interno"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
